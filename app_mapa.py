...
m = folium.Map(location=[-26.9038,-48.6821], zoom_start=13, tiles="cartodbpositron")
...
st.title('Mapa de deliberações do CMGDT de empresas com atividades permissíveis')
